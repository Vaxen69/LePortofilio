...
window.PORTFOLIO_CONTENT = {
  fr: {
      ...
      items: [
        {
          ...
          org: 'KDS',
          url: 'https://kdsgroupe.fr/',
          projectIds: ['audit-app', 'kds-map', 'crm-airtable'],
          logo: 'assets/logo-kds.jpg',
          bullets: ["En alternance chez KDS, j'ai développé une application mobile (Flutter & React Native) pour les audits de copropriétés, conçu un outil de cartographie interne des dossiers et déployé un CRM Airtable sur mesure pour l'équipe opérationnelle."],
        },
        {
          period: '2024 — 2025',
          role: 'Développeur Full-Stack · Stage',
          org: 'Dr J. Chandezon',
          url: 'https://drchandezon.fr',
          projectIds: ['chandezon'],
          logo: 'assets/icon-chandezon.png',
          bullets: ['Stage full-stack — de la maquette Figma au développement HTML/CSS et PHP/MySQL, avec conception de la base de données relationnelle. Site en ligne sur drchandezon.fr.'],
        },
        {
          period: '2025 — 2026',
          role: 'SAÉ · Application mobile transpalette',
          org: 'Intermarché — Les Mousquetaires',
          url: 'https://www.mousquetaires.com',
          projectIds: ['mousquetaires'],
          logo: 'assets/logo-mousquetaires.png',
          bullets: ["Projet académique en partenariat avec Intermarché : application mobile embarquée sur transpalette pour guider les préparateurs pas-à-pas dans l'entrepôt réfrigéré et optimiser leurs tournées. Stack React + API Symfony."],
        },
      ],
    },
    projects: {
    ...
    education: {
      title: 'Formation',
      items: [
        { period: '2023 — 2026', degree: 'BUT Informatique · Réalisation d’applications', school: 'IUT de Valence — UGA · Alternance dès 2025', url: 'https://iut-valence.fr', logo: 'assets/logo-iut-valence.png', bullets: ["C'est là que j'ai vraiment plongé dans le développement — projets concrets dès la première année, alternance en troisième, et une stack qui s'est étoffée à chaque semestre."] },
      ],
    },
    interests: {
  ...
  en: {
      ...
      items: [
        {
          ...
          projectIds: ['audit-app', 'kds-map', 'crm-airtable'],
          logo: 'assets/logo-kds.jpg',
          bullets: ['On apprenticeship at KDS, I built a Flutter & React Native mobile app for condominium audits, created an internal map tool for audit cases, and rolled out a custom Airtable CRM for the operations team.'],
        },
        {
          period: '2024 — 2025',
          ...
          projectIds: ['chandezon'],
          logo: 'assets/icon-chandezon.png',
          bullets: ['Full-stack internship — from interactive Figma mockups to HTML/CSS and PHP/MySQL development with relational database design. Live at drchandezon.fr.'],
        },
        {
          period: '2025 — 2026',
          ...
          projectIds: ['mousquetaires'],
          logo: 'assets/logo-mousquetaires.png',
          bullets: ['University project in partnership with Intermarché: a mobile app for pallet truck order pickers to navigate step-by-step through a refrigerated warehouse. Stack: React + Symfony API.'],
        },
      ],
    },
    projects: {
    ...
    education: {
      title: 'Education',
      items: [
        { period: '2023 — 2026', degree: 'BUT CS · Application Development', school: 'IUT de Valence — UGA · Work-study from 2025', url: 'https://iut-valence.fr', logo: 'assets/logo-iut-valence.png', bullets: ["That's where I really got into development — real projects from year one, an apprenticeship in year three, and a broader stack every semester."] },
      ],
    },
    interests: {
      title: 'Interests',
